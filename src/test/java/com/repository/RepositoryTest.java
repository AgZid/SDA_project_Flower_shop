...
//                .build();
//
//        REPOSITORY.createAndUpdate(roze);
//        REPOSITORY.createAndUpdate(tulpe);
//        REPOSITORY.createAndUpdate(gvazdikas);
//
...
//
//        REPOSITORY.createAndUpdate(john);
//    }
//
//    @AfterEach
//    public void truncateDataBase() {
//        REPOSITORY.deleteAll("FlowersForOrdering");
//        REPOSITORY.deleteAll("Flower");
//        REPOSITORY.deleteAll("FlowersOrder");
...
//                .amount(60)
//                .build();
//        REPOSITORY.createAndUpdate(bijunas);
//
...
//        REPOSITORY.createAndUpdate(gele);
//
...
//
//        REPOSITORY.deleteRecord(flower);
//
